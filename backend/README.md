...
## Project Structure
    ...
    ├── proxy_connectors_demo_2_2  # Django project configurations
...
1. Clone this repo and `cd proxy_connectors_demo_2_2`
...
2. Clone this repo and `cd proxy_connectors_demo_2_2`
